...
/**
 * If you want to use Workmanager + Coroutines for File Management, please check Fileman Repository.
 *
 * ATTENTION: Don't call write, read or delete on Main Thread to avoid UI freeze.
 */
class FilemanLite {
  companion object {
